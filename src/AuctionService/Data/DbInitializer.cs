...
public class DbInitializer
{
    ...
    {
        // using allows us to create and then dispose of the scope
    ...
    {
        // apply migrations if not already applied and create database if not exists
        ...
        context.AddRange(auctions); // Save locally
